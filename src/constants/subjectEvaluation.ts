import { IQualityEvaluation } from '@/domain/subject/subjectEvaluation'
...
export const EVALUATION_NAME = new Map<string, string>([
  ...
  [
    'feedback_admin',
    'Ý kiến HV nhắn gửi BTC để góp phần cải thiện chất lượng lớp học ở các buổi học tiếp theo (MC, các hoạt động,...)',
  ],
  ...
  [
    'feedback_lecturer',
    'Mời bạn gửi đến giảng viên những tâm tình/chia sẻ của mình tại đây nhé:',
  ],
])
