...
export const getSubjectNextMostRecent = (): Promise<ISubjectInResponse> =>
  get(API_LIST.subject + '/next-most-recent')

export const getSubjectLastSentStudentRecent =
  (): Promise<ISubjectInResponse> =>
    get(API_LIST.subject + '/last-sent-student')

export const getSubjectShort = (
  params?: IParamsGetListSubject
...
export const createSubject = (
  data: ICreateSubject
): Promise<ISubjectInResponse> => post(API_LIST.subject, data)

export const updateSubject = (
  id: string,
  data: IUpdateSubject
): Promise<ISubjectInResponse> => put(API_LIST.subject + '/' + id, data)
